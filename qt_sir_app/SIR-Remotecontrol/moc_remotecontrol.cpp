...
**
** Created: Thu May 3 10:13:11 2012
...
int RemoteControl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_launchButton_clicked(); break;
        case 1: on_actionQuit_triggered(); break;
        case 2: on_indexButton_clicked(); break;
        case 3: on_identifierButton_clicked(); break;
        case 4: on_urlButton_clicked(); break;
        case 5: on_syncContentsButton_clicked(); break;
        case 6: on_contentsCheckBox_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 7: on_indexCheckBox_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 8: on_bookmarksCheckBox_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 9: helpViewerClosed(); break;
        case 10: sendCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 11;
    }
