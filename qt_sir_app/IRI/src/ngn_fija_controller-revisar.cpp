...
void NGN_FIJA_Controller::iniciarDF()
{
    ...
    connect(this,SIGNAL(signalsQX2Events(QEvent*)),this->df,SIGNAL(signalNuevoEvento(QEvent*)));
    this->df->start();
}
...
bool NGN_FIJA_Controller::procesarCuerpoTrama()
{
    ...
    case nsFija::nCmdCode_CallRelatedEvent:
        {                        
            ...
            this->buffer=this->bufferTemp.left(this->eventActual->getWLength());
